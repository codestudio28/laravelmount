  ...
  <div id="wrapper">
    ...
    <ul  class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/dashboard">
        ...
        <h4 style="margin-top:1em;">Lipa City</h4>
      ...
      <li class="nav-item">
        ...
        <div id="collapseScholarship" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="/tugon">Buy Property</a>
            <a class="collapse-item" href="/admin-senior-high">Collections</a>
            <a class="collapse-item" href="/admin-college">Account's Payable</a>
            <a class="collapse-item" href="/admin-college">Transfer Property</a>
          </div>
        </div>
      </li>
     ...
     <!-- Nav Item - Pages Collapse Menu -->
      <li class="nav-item">
        ...
        <div id="collapseSchoolYear" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="/admin-school-year">Property</a>
            <a class="collapse-item" href="/admin-school-year">Client</a>
            <a class="collapse-item" href="/admin-school-year">Paymet Type</a>
            <a class="collapse-item" href="/admin-school-year">Collections</a>
            <a class="collapse-item" href="/admin-school-year">Logs</a>
          </div>
        </div>
      </li>
       <li class="nav-item">
    ...
    @elseif(session('Data')[0]->usertype=="user")
        <ul  class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
     ...
     <li class="nav-item">
        ...
        <div id="collapseScholarship" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="/user-tugon">Tugon</a>
            <a class="collapse-item" href="/user-senior-high">Senior High</a>
            <a class="collapse-item" href="/user-college">College Financial/Scholars</a>
          </div>
        </div>
      </li>
       <!-- Nav Item - Utilities Collapse Menu -->
